...
import com.example.java_sticker.StartScreen;
...
public class FragMypage_Login extends Fragment {
    private View view;
    ...
    public View onCreateView(@Nullable LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragmypage_login, container, false);
