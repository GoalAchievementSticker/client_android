...
public class GroupDialog {
   ...
   // String[] uid;
    ...
    public GroupDialog(int gCount, String gTittle,int limit,String auth, String key, int gGoal,String cate, int limit_count, String w_uid, String name, String uid_auth){
        this.gCount = gCount;
